<div class="easyui-dialog" data-options="iconCls:'fa fa-pencil-square-o',resizable:true,modal:true,title:'更改出库发货时间'"
    ...
    <form id="fm" class="winedit c8myform mainmodel" method="post" novalidate>
        <div class="fitem">
            <label>设置价格:</label>
            <input c8name="cost" id="Title" style="width:160px" class="easyui-textbox" required="true">
...
<div id="dlg-buttons">
    <a href="javascript:void(0)" class="easyui-linkbutton" iconcls="fa fa-floppy-o" c8data-bind="click:saveCost">保存</a>
