vm.Book = vm.Book || {};
vm.Book.edit = function (dataParameter) {
    this.ParentModel = null;
    this.mode = null;
    var base = this;//
    var editurl = "/Book/edit";
    var saveDetailModelUrl = "/Book/saveajax";
    var getUrl = "/Book/get";
    this.modelInfo = {};
    ...
    this.griddataParameter.pageUrl = "/Book/getCartoonDetailListByParentId";
    ...
    this.griddataParameter.dataoptions = {
        remoteSort: false, onClickCell: onclickcell, idField: "RowId", showFooter: true, columns: [[
            ...
            {title: '内容', field: 'Content', width: 300, align: 'left', editor: {type: 'textbox'}}
...
//初始化
    ...
    this.editWin = function (rowId) {
        ...
        base.productgridModel.pCustomerGetPage({BookRowId: base.modelInfo.RowId});
        base.updateFooter();
    }
    ...
    this.getSort = function () {
        ...
        if (result && result.length > 0) {
            ...
            for (var i = 0; i < result.length; i++) {
                if (parseInt(result[i].Sort) > sort) {
                    sort = parseInt(result[i].Sort);
                }
            }
            return sort+1;
        } else {
    ...
    this.saveDetailModel = function (callBack) {
        ...
        var context = win.c8GetElementListBySelector(".mainmodel");
        modelResult.Book = win.c8GetFormModel({
