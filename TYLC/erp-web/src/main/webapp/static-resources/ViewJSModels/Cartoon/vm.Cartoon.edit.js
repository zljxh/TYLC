...
vm.Cartoon.edit = function (dataParameter) {
    ...
    this.griddataParameter.pageUrl = "/SellOrder/getSellOrderDetailListByParentId";
...
//初始化
    ...
    this.editWin = function (rowId) {
        ...
        base.clear();
        var fullname = this.modelInfo.RegionName;
        var arr = fullname.split('_');


        base.productgridModel.pCustomerGetPage({SellOrderRowId: base.modelInfo.RowId});
        base.paygridModel.pCustomerGetPage({SellOrderRowId: base.modelInfo.RowId});
        base.updateFooter();
    }
