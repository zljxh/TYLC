...
(function($){ 	
	...
	// 2018年1月20日 JX fixbug 当bootstrap-table 使用本js时 .JCLRFlex{width:auto!important;} 会导致table列计算无效页面显示出错改为 .JCLRFlex{width:auto}
	// 2018年1月21日 JX fixbug 最后一个拖动列添加margin-left: -11px; 防止table显示异常
    h.append("<style type='text/css'>  .JColResizer{table-layout:fixed;} .JColResizer > tbody > tr > td, .JColResizer > tbody > tr > th{overflow:hidden;padding-left:0!important; padding-right:0!important;}  .JCLRgrips{ height:0px; position:relative;} .JCLRgrip{margin-left:-5px; position:absolute; z-index:5; } .JCLRgrip .JColResizer{position:absolute;background-color:red;filter:alpha(opacity=1);opacity:0;width:10px;height:100%;cursor: e-resize;top:0px} .JCLRLastGrip{position:absolute; width:1px;margin-left: -11px; } .JCLRgripDrag{ border-left:1px dotted black;	} .JCLRFlex{width:auto;} .JCLRgrip.JCLRdisabledGrip .JColResizer{cursor:default; display:none;}</style>");
	...
	*/
	...
	var onResize = function(){
		//2018-06-23 JX bug修正 当浏览器高度变化时bootstrap table列宽度异常（代码注释）
		//for(var t in tables){
