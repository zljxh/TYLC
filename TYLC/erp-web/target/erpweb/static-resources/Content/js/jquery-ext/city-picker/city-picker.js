...
(function (factory) {
    /*if (typeof define === 'function' && define.amd) {
        ...
        // Browser globals.
        factory(jQuery, ko.getChineseDistricts(null));
    }*/
    factory(jQuery, ko.getChineseDistricts(null));
    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                //dropdown = '<div class="city-picker-dropdown" style="left:' + left + 'px;top:' + top + 'px;' +
        ...
        output: function (type) {
            ...
            //var arr=new Array();
            // arr.push({"标题1":"12:00","type":"内容1"});
            //   var vvv2=  ko.toJSON(arr);
            districts = $.isNumeric(code) ? ChineseDistricts[code] : null;
            var vvv = ko.toJSON(ChineseDistricts[code]);
            //if( type === CITY) {
            //    districts = "110100:'北京市'";
            //}
            //if(type==DISTRICT)
            //{
            //    districts = "110101: '东城区',110102: '西城区',110105: '朝阳区',110106: '丰台区',110107: '石景山区',110108: '海淀区',110109: '门头沟区',110111: '房山区',110112: '通州区',110113: '顺义区',110114: '昌平区',110115: '大兴区',110116: '怀柔区',110117: '平谷区',110228: '密云县',110229: '延庆县'";
            //}
