...
vm.Control.SelectOperator = function (griddataParameter) {
    var base = this;
    this.c8winId=null;
    ...
    this.winUrl = "/BusinessControl/getControlView?ControlName=SelectOperator";
    this.baseModel = null;
    ...
    this.griddataParameter.dataoptions = {
        columns: [
            [
                ...
                {title: '任务类型', field: 'Code', width: 120, align: 'right'},
                {title: '任务编号', field: 'Name', width: 120, align: 'right'}
            ]
