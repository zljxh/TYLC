...
vm.Control.MultiSelectPurchaseOrderModelInstoraged=function(griddataParameter)
{
    var base=this;
    ...
    this.griddataParameter.pageUrl = "/BusinessControl/GetPageMultiSelectPurchaseOrderByPQPInstoraged";
    this.griddataParameter.countUrl = "/BusinessControl/GetCountMultiSelectPurchaseOrderByPQPInstoraged";
