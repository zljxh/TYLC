    ...
    $.jgrid.extend({
        ...
        delRowData : function(rowid) {
            ...
            this.each(function() {
                ...
                if($.isFunction($t.p.afterDelRow)){$t.p.afterDelRow.call($t,rowid);}
            });
            return success;
        },
    ...
    $.jgrid.extend({
        ...
        restoreCell : function(iRow, iCol) {
            return this.each(function(){
                ...
                window.setTimeout(function () { $.jgrid.getMyThis().$("#"+$t.p.knv).attr("tabindex","-1").focus();},0);
            });
        },
    ...
    $.jgrid.extend({
        ...
        gridResize : function(opts) {
            return this.each(function(){
                ...
                $.jgrid.getMyThis().$("#gbox_"+gID).resizable(opts);
            });
        }
    });
})(jQuery);
